...
class res_currency(models.Model):
    ...
    inverse_rate = fields.Float(
        'Current Inverse Rate', digits=(12, 2),
    ...
    rate = fields.Float(compute='_compute_current_rate', string='Current Rate', digits=(15, 15),
...
class res_currency_rate(models.Model):
    ...
    rate = fields.Float(string='Current Rate', digits=(15, 15),)
